            ...
            <div className="flex mf:flex-col items-start justify-between md:p-20 py-12 px-4">
                <div className="flex flex-1 justify-start flex-col mf:mr-10">
                    ...
                    <p className="text-left mt-5 text-white font-light md:w-9/12 w-11/12 text-base">
                        Buy and sell cryptocurrencises easiily on the Krypto
                    </p>
                    ...
                    <div className="grid sm:grid-cols-3 grid-col-2 mt-10 ">
                ...
                <div className="flex flex-col flex-1 items-center justify-start w-full mf:mt-0 mt-10">
                    ...
                    <div className="p-5 sm:w-96 w-full flex flex-col justify-start items-center blue-glassmorphism">
                        ...
                        {false ? (
                            ...
                            <button type="button" className="text-white w-full mt-2 border-[1px] p-2 border-[#3d4f7c] rounded-full curdor-pointer" onClick={() => {handleSubmit()}}>
                                Send now
                            </button>
                        )}
                    </div>
